...
<td>
	<input class="input input-sm w-full" bind:value={newValues[id].nama} placeholder="Nama" />
</td>
<td>
...
<td>
	<input class="input input-sm w-full" bind:value={newValues[id].username} placeholder="Username" />
</td>
<td>
	<input
		type="password"
