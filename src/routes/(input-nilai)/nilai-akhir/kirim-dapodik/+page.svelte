...
>
	{#snippet children({ submitting })}
		<h3 class="mb-1 text-xl font-bold">Kirim Nilai ke Dapodik</h3>
		<p class="mb-4 text-sm opacity-70">
			Mengirim nilai akhir kelas {data.kelasNama ?? '-'} ke aplikasi Dapodik desktop sekolah melalui Web
			Service (Bearer token), sesuai alur matev rapor e-Rapor.
		</p>
