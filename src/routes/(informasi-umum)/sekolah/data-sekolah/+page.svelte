...
>
	...
	<div class="flex-shrink-0">
		...
		>
			<img src="/sekolah.png" alt="Logo sekolah" class="h-32 w-32 object-contain" />
		</div>
	</div>
	<!-- Data Sekolah -->
	<div class="space-y-4">
		<h2 class="text-base-content mb-4 text-2xl font-bold">SD Negeri 19 Periji</h2>
		<div class="grid grid-cols-1 items-start gap-4 sm:grid-cols-3">
			...
			<div class="text-base-content sm:col-span-2">Sekolah Dasar</div>
		</div>
		<div class="grid grid-cols-1 items-start gap-4 sm:grid-cols-3">
		...
		<div class="grid grid-cols-1 items-start gap-4 sm:grid-cols-3">
			...
			<div class="text-primary break-all underline sm:col-span-2">
				<a href="https://sdn19periji.sch.id" target="_blank">https://sdn19periji.sch.id/</a>
			</div>
		</div>
		<div class="grid grid-cols-1 items-start gap-4 sm:grid-cols-3">
			<div class="text-base-content/70 text-sm font-semibold">Email Sekolah</div>
			<div class="link link-accent break-all sm:col-span-2">cs@sdn19periji.sch.id</div>
		</div>
	</div>
	<!-- Edit -->
	<a
