...
async function main() {
	...
	try {
		...
		const checks = [
			...
			{ table: 'auth_user', column: 'nama_lengkap', type: 'TEXT' },
			{ table: 'auth_user', column: 'tempat_lahir', type: 'TEXT' },
			{ table: 'auth_user', column: 'tanggal_lahir', type: 'TEXT' },
			{ table: 'auth_user', column: 'jenis_kelamin', type: 'TEXT' },
			{ table: 'auth_user', column: 'ijazah', type: 'TEXT' },
			{ table: 'auth_user', column: 'tahun_ijazah', type: 'INTEGER' },
			{ table: 'auth_user', column: 'status_kepegawaian', type: 'TEXT' },
			{ table: 'auth_user', column: 'golongan', type: 'TEXT' },
			{ table: 'auth_user', column: 'jabatan', type: 'TEXT' },
			{ table: 'auth_user', column: 'pangkat', type: 'TEXT' },
			{ table: 'auth_user', column: 'tanggal_diangkat', type: 'TEXT' },
			{ table: 'auth_user', column: 'tanggal_bekerja', type: 'TEXT' },
			{ table: 'auth_user', column: 'tanggal_gaji_berkala', type: 'TEXT' },
