...
CREATE UNIQUE INDEX IF NOT EXISTS "asesmen_kokurikuler_unique"
    ON "asesmen_kokurikuler" ("murid_id", "kokurikuler_id", "dimensi");

CREATE INDEX IF NOT EXISTS "asesmen_kokurikuler_murid_idx"
    ON "asesmen_kokurikuler" ("murid_id");

CREATE INDEX IF NOT EXISTS "asesmen_kokurikuler_kokurikuler_idx"
    ON "asesmen_kokurikuler" ("kokurikuler_id");
