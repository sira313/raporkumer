...
CREATE UNIQUE INDEX IF NOT EXISTS "asesmen_formatif_murid_tujuan_unique"
    ON "asesmen_formatif" ("murid_id", "tujuan_pembelajaran_id");

CREATE INDEX IF NOT EXISTS "asesmen_formatif_murid_idx"
    ON "asesmen_formatif" ("murid_id");

CREATE INDEX IF NOT EXISTS "asesmen_formatif_mapel_idx"
    ON "asesmen_formatif" ("mata_pelajaran_id");

CREATE INDEX IF NOT EXISTS "asesmen_formatif_tujuan_idx"
    ON "asesmen_formatif" ("tujuan_pembelajaran_id");
